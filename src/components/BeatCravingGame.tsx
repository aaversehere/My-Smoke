                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-4 p-4 rounded-xl border transition-all duration-300 ${
                      isSelected
                        ? 'bg-sage-500/20 border-sage-500 scale-[1.02] shadow-[0_0_15px_rgba(92,131,88,0.2)]'
                  ...
                  >
                    ...
                    {isSelected && (
                      <span className="material-symbols-outlined ml-auto text-sage-500">check_circle</span>
                    )}
                  </button>
                );
              })}
          ...
          {[1, 2, 3].map((m) => (
            <div 
              ...
              className={`h-2 rounded-full transition-all duration-300 ${
                m === level ? 'w-10 bg-sage-400' : m < level ? 'w-3 bg-sage-500/50' : 'w-3 bg-zinc-100 dark:bg-zinc-800'
              }`}
            />
          ))}
        </div>
