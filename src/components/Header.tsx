    ...
    <header className="fixed top-0 inset-x-0 z-50 bg-white/90 dark:bg-[#09090b]/90 backdrop-blur-xl pt-safe border-b border-zinc-200/80 dark:border-zinc-800/80 transition-all">
      ...
      <div className="h-14 px-6 flex items-center justify-between w-full">
        <button 
          ...
          className="font-['Montserrat'] font-bold text-xl text-sage-600 dark:text-sage-400 flex items-center gap-1.5 hover:opacity-90 transition-opacity"
        >
          SmokeFree Quest
        </button>
        ...
        <div className="flex items-center gap-2">
          ...
          <button 
            ...
            className="w-8 h-8 rounded-full bg-sage-500 text-white dark:text-black flex items-center justify-center font-bold shadow-md hover:scale-105 active:scale-95 transition-all"
          >
        ...
        <button
          ...
          className={`whitespace-nowrap flex-shrink-0 px-3 py-1 rounded-full transition-all ${
            currentScreen === 'welcome' 
              ? 'bg-sage-500/20 text-sage-600 dark:text-sage-400 border border-sage-500/30 shadow-xs' 
      ...
      <div className="h-1 w-full bg-zinc-200 dark:bg-zinc-800 overflow-hidden">
        <div 
          className="h-full bg-sage-500 transition-all duration-500 rounded-r-full shadow-[0_0_10px_rgba(92,131,88,0.5)]"
