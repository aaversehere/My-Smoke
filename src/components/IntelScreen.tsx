  ...
  return (
    <div className="flex flex-col w-full gap-8 relative z-10 pb-16 pt-2 px-6 md:px-12 lg:px-24 min-h-[calc(100vh-80px)]">
      ...
      <div className="flex flex-col gap-2 items-center text-center mt-2">
        ...
        <h1 className="font-['Montserrat'] font-extrabold text-[26px] sm:text-[30px] text-white">
          What's Actually in There?
        </h1>

        <p className="font-['Quicksand'] font-medium text-base text-zinc-400 max-w-[300px]">
      ...
      <div className="flex flex-col gap-4 w-full" id="mission-cards">
        ...
        <div 
          ...
          className={`mission-card relative bg-zinc-900 rounded-xl p-5 shadow-lg transform transition-all duration-300 active:scale-95 cursor-pointer border-t-4 border-emerald-500 border-x border-b border-zinc-800 ${
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex flex-col pr-6">
              <h2 className="font-['Montserrat'] font-bold text-xl text-white">Nicotine</h2>
              <p className="font-['Quicksand'] font-medium text-zinc-400 mt-1 text-sm leading-relaxed">
                The hook. It rewires your brain to constantly crave more, making you feel anxious until your next fix.
              </p>

              {expandedCard === 1 && (
                <div className="mt-3 pt-3 border-t border-zinc-800 text-xs text-emerald-300 font-['Quicksand'] font-bold bg-zinc-800/80 p-2.5 rounded-lg animate-fadeIn">
          ...
          <div className="absolute top-3 right-3 w-8 h-8 rounded-full bg-zinc-800 flex items-center justify-center opacity-70 hover:opacity-100">
        ...
        <div 
          ...
          className={`mission-card relative bg-zinc-900 rounded-xl p-5 shadow-lg transform transition-all duration-300 active:scale-95 cursor-pointer border-t-4 border-amber-500 border-x border-b border-zinc-800 ${
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex flex-col pr-6">
              <h2 className="font-['Montserrat'] font-bold text-xl text-white">Tar</h2>
              <p className="font-['Quicksand'] font-medium text-zinc-400 mt-1 text-sm leading-relaxed">
                The sticky stuff. It coats your lungs like paving a road, paralyzing the tiny hairs that keep them clean.
              </p>

              {expandedCard === 2 && (
                <div className="mt-3 pt-3 border-t border-zinc-800 text-xs text-amber-300 font-['Quicksand'] font-bold bg-zinc-800/80 p-2.5 rounded-lg animate-fadeIn">
        ...
        <div 
          ...
          className={`mission-card relative bg-zinc-900 rounded-xl p-5 shadow-lg transform transition-all duration-300 active:scale-95 cursor-pointer border-t-4 border-red-500 border-x border-b border-zinc-800 ${
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex flex-col pr-6">
              <h2 className="font-['Montserrat'] font-bold text-xl text-white">Carbon Monoxide</h2>
              <p className="font-['Quicksand'] font-medium text-zinc-400 mt-1 text-sm leading-relaxed">
                The oxygen thief. It replaces oxygen in your blood, making your heart work overtime just to keep up.
              </p>

              {expandedCard === 3 && (
                <div className="mt-3 pt-3 border-t border-zinc-800 text-xs text-red-300 font-['Quicksand'] font-bold bg-zinc-800/80 p-2.5 rounded-lg animate-fadeIn">
      ...
      <div className="mt-4 flex flex-col gap-3 items-center w-full">
        ...
        <p className="font-['Quicksand'] font-bold text-zinc-400 text-sm text-center flex items-center justify-center gap-1">
